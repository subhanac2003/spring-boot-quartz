...
public class JobServiceImpl implements JobService{
	 ...
	 */
	@Override
	public boolean scheduleOneTimeJob(String jobName, Class<? extends QuartzJobBean> jobClass, Date date,String instance_id) {
		...
		JobDetail jobDetail = JobUtil.createJob(jobClass, false, context, jobKey, groupKey, instance_id);
	 ...
	 */
	@Override
	public boolean scheduleCronJob(String jobName, Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression, String instance_id) {
		System.out.println("Request received to scheduleJob");
		...
		try {
			...
			for (String groupName : scheduler.getJobGroupNames()) {
				for (JobKey jobKey : scheduler.getJobKeys(GroupMatcher.jobGroupEquals(groupName))) {
					...
					String instanceId = jobDetail.getJobDataMap().getString("instance_id");
	...
	@Override
	public List<Map<String, Object>> getAllIntanceIds() {
		
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		
		List<Instance> instances = StartStopInstance.getAllInstances();
		for(Instance instance : instances) {
			System.out.println(instance);
			Map<String,Object> map = new HashMap<String,Object>();
			map.put("instance_id", instance.getInstanceId());
			map.put("instance_type", "EC2");
			
			list.add(map);
		}
		
		List<DBInstance> dbInstances = StartStopRdsInstance.getAllInstances();
		for(DBInstance instance : dbInstances) {
			System.out.println(instance);
			Map<String,Object> map = new HashMap<String,Object>();
			map.put("instance_id", instance.getDBInstanceIdentifier());
			map.put("instance_type", "RDS");
