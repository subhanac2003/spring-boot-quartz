...
public class StartInstanceJob extends QuartzJobBean implements InterruptableJob{
	...
	protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		System.out.println("Start Instance Job started with key :" + key.getName() + ", Group :"+key.getGroup() + " , Thread Name :"+Thread.currentThread().getName() + " ,Time now :"+new Date());
		...
		try {
			...
			StartStopInstance.startInstance(instance_id);
