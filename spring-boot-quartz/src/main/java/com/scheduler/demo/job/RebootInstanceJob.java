...
public class RebootInstanceJob extends QuartzJobBean implements InterruptableJob{
	...
	protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		System.out.println("Reboot Instance Job started with key :" + key.getName() + ", Group :"+key.getGroup() + " , Thread Name :"+Thread.currentThread().getName() + " ,Time now :"+new Date());
		...
		try {
			...
			StartStopInstance.rebootInstance(instance_id);
